...
> **Note**
> Everywhere in this repository, make sure to replace `silver-ublue-saigon/silver-ublue-saigon` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
...
Read [the README in the `scripts/` directory](https://github.com/silver-ublue-saigon/silver-ublue-saigon/blob/main/scripts/README.md) for more information.
...
```
sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/silver-ublue-saigon/silver-ublue-saigon:20230403
```
...
To run the action, simply edit the `boot_menu.yml` by changing all the references to `silver-ublue-saigon/silver-ublue-saigon` to your repository. This should trigger the action automatically.
